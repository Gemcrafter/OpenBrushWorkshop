...
public class SENaturalBloomAndDirtyLens : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        // CLEANED UP LEGACY WARNINGS: Evaluates hardware capacity directly without obsolete flags
    ...
    {
        // SAFETY GATE INITIALIZATION: If the incoming frame dimensions are completely uninitialized (0x0),
        // pass the canvas texture through raw to prevent the RenderTextureDesc height crash.

...
// Open Brush / Tilt Brush: ShadowCaster removed (Unity 2022.3 struct mismatch).
// Intent: no shadow casting, no shadow receiving on this shader.
...
#define TB_VERT_ADD VertexOutputForwardAdd
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      // noshadow: do not receive shadows
    ...
    Pass
    {
      ...
      // noshadow: do not receive shadows from additional lights
    ...
    // ShadowCaster pass intentionally omitted — this material must not cast shadows.
  ...
  // Do not fall back to VertexLit (it can cast shadows).
  Fallback Off

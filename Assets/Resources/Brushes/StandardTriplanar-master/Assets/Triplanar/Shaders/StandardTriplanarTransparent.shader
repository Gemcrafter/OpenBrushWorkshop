...
Shader "Standard Triplanar Transparent"
{
    ...
    {
        Cull Back
        Tags {"Queue" = "Transparent" "RenderType"="Transparent" } //BackCulling Differs from opaque

        CGPROGRAM

        #pragma surface surf Standard vertex:vert fullforwardshadows addshadow alpha //alpha channel added

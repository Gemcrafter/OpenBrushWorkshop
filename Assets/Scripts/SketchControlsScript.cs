...
namespace TiltBrush
{
    ...
    public class SketchControlsScript : MonoBehaviour
    {
        ...
        public ControllerGrabVisuals ControllerGrabVisuals
        {
            get
            {
                return m_ControllerGrabVisuals;
            }
        }
        ...
        public SketchMemoryScript.PlaybackMode SketchPlaybackMode
        {
            get
            {
                return m_SketchPlaybackMode;
            }
            set
            {
                m_SketchPlaybackMode = value;
            }
        }
        ...
        {
            return m_PanelManager.m_SweetSpot.transform.position;
        }
        public void SetSketchOrigin(Vector3 vOrigin)
        {
            m_SketchOrigin = vOrigin;
        }
        ...
        {
            return m_GrabWand.grabbingWorld || m_GrabBrush.grabbingWorld;
        }
        public bool IsUserGrabbingWorldWithBrushHand()
        {
            return m_GrabBrush.grabbingWorld;
        }
        ...
        {
            return m_GazePanelDectivationCountdown / m_GazePanelDectivationDelay;
        }
        public bool IsCurrentGrabWidgetPinned()
        {
            return IsUserInteractingWithAnyWidget() && m_CurrentGrabWidget.Pinned;
        }
        public bool CanCurrentGrabWidgetBePinned()
        {
            return IsUserInteractingWithAnyWidget() && m_CurrentGrabWidget.AllowPinning;
        }
        public bool DidUserGrabWithBothInside()
        {
            return m_GrabBrush.startedGrabInsideWidget && m_GrabWand.startedGrabInsideWidget;
        }
        public bool IsUserGrabbingWidget(GrabWidget widget)
        {
            return widget == m_CurrentGrabWidget;
        }
        public bool IsUserTwoHandGrabbingWidget()
        {
            return m_GrabWidgetState == GrabWidgetState.TwoHands;
        }
        public bool IsPinCushionShowing()
        {
            return m_PinCushion.IsShowing();
        }
        ...
        public IconTextureAtlas IconTextureAtlas
        {
            get
            {
                return GetComponent<IconTextureAtlas>();
            }
        }
                                       ...
                                       int iParam2 = -1, string sParam = null)
        {
            switch (rEnum)
            {
                ...
                case GlobalCommands.ExportListed:
                    ...
                    break;
                case GlobalCommands.RenderCameraPath: // Offline rendering added
                    if (App.Config.OfflineRender)
                    {
                        // Headless two-pass offline render
                        if (CameraPathCaptureRig.m_Instance != null)
                        {
                            CameraPathCaptureRig.m_Instance.StartOfflineRender();
                        }
                    }
                    else
                    {
                        // Normal in-game camera path recording / rendering

...
namespace TiltBrush
{
    ...
    public class LoadSketchButton : BaseButton
    {
        ...
        public bool ThumbnailLoaded
        {
            get
            {
                return m_ThumbnailLoaded;
            }
            set
            {
                m_ThumbnailLoaded = value;
            }
        }
        ...
        public float FadeIn
        {
            set
            {
                SetMaterialFloat("_FadeIn", value);
            }
        }
        ...
        public bool WarningVisible
        {
            ...
            get
            {
                return m_Warning != null && m_Warning.activeSelf;
            }
        }
        ...
        override protected void OnButtonPressed()
        {
            ...
            if (m_SketchSet != null)
            {
                var sfi = m_SketchSet.GetSketchSceneFileInfo(m_SketchIndex);
                available = sfi != null && sfi.Available;
            }
            Debug.LogError(
                "[LoadSketchButton.OnButtonPressed] LOADBTN: press index=" + m_SketchIndex +
                " set=" + (m_SketchSet != null ? m_SketchSet.Type.ToString() : "null") +
                " available=" + available +

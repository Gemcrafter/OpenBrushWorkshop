...
namespace TiltBrush
{
    ...
    public class BasePanel : MonoBehaviour
    {
        ...
        public enum PanelType
        {
            ...
            BrushCuration = 20302,
            MirrorControls = 20303,
            AdvancedLaunch = 20304,
            MultiMirrorSettings = 20305,
        }
        ...
        {
            return m_PositioningExtent;
        }
        public bool IsAvailable()
        {
            return m_CurrentState != PanelState.Unavailable;
        }
        ...
        public bool CanBeDetached
        {
            get
            {
                return m_CanBeDetachedFromWand;
            }
        }
        ...
        public bool CurrentlyVisibleInAdvancedMode
        {
            get
            {
                return m_CurrentlyVisibleInAdvancedMode;
            }
        }
        ...
        public float PopUpOffset
        {
            get
            {
                return m_ActivePopUp ? m_ActivePopUp.GetPopUpForwardOffset() : 0;
            }
        }
        ...
        {
            return m_CurrentState != PanelState.Unused;
        }
        ...
        {
            return m_ActivePopUp != null;
        }

        public void ClearDelayedPopupCommand()
        {
        ...
        protected virtual bool GazeDismissesActivePopUp()
        {
            return true;
        }
        ...
        protected void UpdateState()
        {
            ...
            if (bGazeDescriptionsWereActive != m_GazeDescriptionsActive)
            {
                ...
                else
                {
                    ...
                    if (m_ActivePopUp != null && GazeDismissesActivePopUp())
                    {
        ...
        public void UpdatePanel(Vector3 vToPanel, Vector3 vHitPoint)
        {
            ...
            if (m_ActivePopUp != null)
            {
                    ...
                    m_ActivePopUp.GetCollider(), out hitInfo))
                {
                    ...
                    (GazeDismissesActivePopUp() && m_PopUpGazeTimer > m_PopUpGazeDuration)))
                {

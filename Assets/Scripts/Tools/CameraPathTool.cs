...
namespace TiltBrush
{
    public class CameraPathTool : BaseTool
    {
        public enum Mode
        {
            ...
            RemoveKnot,
            Recording,
            Idle // inert: no place/delete on trigger
        }
        ...
        override public void UpdateTool()
        {
            ...
            // Inert mode: stay on path tool/panel; do not place or remove knots.
...
namespace TiltBrush
{
    ...
    public class CameraPathTool : BaseTool
    {
        public enum Mode
        {
            ...
            RemoveKnot,
            Recording,
            Idle  // inert for now prevents default AddPositionKnot
        }

...
namespace TiltBrush
{
    ...
    public class PanelWidget : GrabWidget
    {
        ...
        override protected void OnTossComplete()
        {
            ...
            MirrorControlsPanel mirrorPanel = m_PanelSibling as MirrorControlsPanel;
            if (mirrorPanel != null)
            {
                mirrorPanel.NotifyDismissedByUser();
            }
        }
        ...
        protected override void OnUserEndInteracting()
        {
            ...
            PanelManager.m_Instance.RefreshConfiguredFlag();
            AdvancedLaunchPanel.LogReleasedLaunchPanel(PanelSibling);
        }
